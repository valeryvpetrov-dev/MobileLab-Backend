...
-- Database: SaaS-api_db_production

-- DROP DATABASE "SaaS-api_db_production";

CREATE DATABASE "SaaS-api_db_production"
    WITH
...
COMMENT ON DATABASE "SaaS-api_db_production"
    IS 'MobileLab-Backend project. Database for production.';